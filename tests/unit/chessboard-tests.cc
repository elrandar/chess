...
TEST_F(chessboard, do_execute_move)
{
    ...
    EXPECT_EQ(chessboard.getBoardRpr().at(pos2).value(),
              std::pair(PieceType::PAWN, Color::WHITE));
}
...
TEST_F(chessboard, do_move_undo_capture)
{
    ...
    EXPECT_TRUE(chessboard.getBoardRpr().at(pos1).has_value());
    EXPECT_EQ(chessboard.getBoardRpr().at(pos2).value(),
              std::pair(PieceType::ROOK, Color::BLACK));
}
...
TEST_F(chessboard, do_move_undo_capture_promotion)
{
    ...
    EXPECT_FALSE(chessboard.getBoardRpr().at(pos1).has_value());
    EXPECT_EQ(chessboard.getBoardRpr().at(pos2).value(),
              std::pair(PieceType::QUEEN, Color::WHITE));
    chessboard.undo_move(move);
    EXPECT_EQ(chessboard.getBoardRpr().at(pos1).value(),
              std::pair(PieceType::PAWN, Color::WHITE));
    EXPECT_EQ(chessboard.getBoardRpr().at(pos2).value(),
              std::pair(PieceType::ROOK, Color::BLACK));
}
...
TEST_F(chessboard, is_check_true)
{
    using namespace board;
    auto chessboard =
        Chessboard(perft_parser::parse_fen("4r3/8/8/8/8/8/4K3/8 w KQkq - 0"));
...
TEST_F(chessboard, castling_test_white_king_side)
{
    ...
    EXPECT_EQ(rpr.at(Position(5)).value(),
              (std::pair<PieceType, Color>(PieceType::ROOK, Color::WHITE)));
    EXPECT_EQ(rpr.at(Position(6)).value(),
              (std::pair<PieceType, Color>(PieceType::KING, Color::WHITE)));
}
...
TEST_F(chessboard, castling_test_white_queen_side)
{
    ...
    EXPECT_EQ(rpr.at(Position(3)).value(),
              (std::pair<PieceType, Color>(PieceType::ROOK, Color::WHITE)));
    EXPECT_EQ(rpr.at(Position(2)).value(),
              (std::pair<PieceType, Color>(PieceType::KING, Color::WHITE)));
}
...
TEST_F(chessboard, castling_test_black_king_side)
{
    ...
    EXPECT_EQ(rpr.at(Position(61)).value(),
              (std::pair<PieceType, Color>(PieceType::ROOK, Color::BLACK)));
    EXPECT_EQ(rpr.at(Position(62)).value(),
              (std::pair<PieceType, Color>(PieceType::KING, Color::BLACK)));
}
...
TEST_F(chessboard, castling_test_black_queen_side)
{
    ...
    EXPECT_EQ(rpr.at(Position(59)).value(),
              (std::pair<PieceType, Color>(PieceType::ROOK, Color::BLACK)));
    EXPECT_EQ(rpr.at(Position(58)).value(),
              (std::pair<PieceType, Color>(PieceType::KING, Color::BLACK)));
    ...
    EXPECT_EQ(rpr.at(Position(56)).value(),
              (std::pair<PieceType, Color>(PieceType::ROOK, Color::BLACK)));
    EXPECT_EQ(rpr.at(Position(60)).value(),
              (std::pair<PieceType, Color>(PieceType::KING, Color::BLACK)));
}
