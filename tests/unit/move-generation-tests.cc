...
TEST_F(move_generation, pawn_attacks) {
    ...
    auto fenObj = perft_parser::parse_fen("8/8/8/8/n1n2n1n/1P4P1/8/8 w - - 0 1");
...
TEST_F(move_generation, pawn_promotion) {
    ...
    expectedMoves.emplace_back(Position(File::B, Rank::SEVEN),
                               Position(File::B, Rank::EIGHT),
                               board::PieceType::PAWN, std::optional<PieceType>(PieceType::QUEEN));
    expectedMoves.emplace_back(Position(File::F, Rank::SEVEN),
...
TEST_F(move_generation, pawn_promotion_capture_black) {
    ...
    expectedMoves.emplace_back(Position(File::B, Rank::TWO),
